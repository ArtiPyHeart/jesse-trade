...
from custom_indicators.toolbox.labeler.triple_barrier import z_score_filter
from custom_indicators.toolbox.multiprocess import mp_pandas_obj
from custom_indicators.toolbox.volatility import get_yang_zhang_vol
...
class TripleBarrierLabelerRaw:
    ...
    def side_labels(
        ...
        side_labels = get_bins(events, self._close_series)
        return side_labels
    ...
    def meta_labels(
        ...
        meta_labels = get_bins(side_events, self._close_series)
        return meta_labels
