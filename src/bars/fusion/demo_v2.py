...
class DemoBarV2(FusionBarContainerBase):
    ...
    输出: 20,652 根 Fusion Bar
    压缩比: 76.4:1 (约 1.27 小时/根)

    评估结果:
      综合评分: 68.7/100 (B)
      趋势性: 3.28/5 | 一致性: 4.56/5 | 稳定性: 2.12/5
      Hurst均值: 0.697 | 三重共识: 35.1%

    评分分布 (窗口/均分/1分/2分/3分/4分/5分):
      20:  2.98 | 10.0% | 21.1% | 43.4% |  2.8% | 20.9%
      40:  3.43 |  5.5% | 14.5% | 42.2% |  4.3% | 32.9%
      60:  3.41 |  8.1% | 21.5% | 25.8% |  7.1% | 36.7%
    """
