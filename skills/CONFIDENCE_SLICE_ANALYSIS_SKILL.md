...
**辅助判断方法**：想象用一条线性回归直线拟合置信度切片中的收益曲线，通过这条想象直线的斜率辅助判断：
- 斜率大幅 > 0 → 倾向 good（整体上升趋势）
- 斜率大幅 < 0 → 倾向 reverse（整体下降趋势）
- 斜率 ≈ 0 → 倾向 giveup（无明确方向性）

此方法可减少对局部波动的过度关注，聚焦于整体趋势。
...
1. **整体下降趋势**：最终收益<0 且 平均收益<0，允许以下情况：
   - 中途横盘震荡（震荡调整幅度小于前期下降幅度的50%）
   - 小幅反弹后继续下跌（反弹盈利幅度不超过累计亏损的50%）
   - 阶段性企稳后继续下降
...
2. **剧烈盈亏切换**：曲线反复穿越零线（或平均收益线），呈现以下模式：
   - **S型/W型/M型波动**：先盈利→亏损→盈利，或先亏损→盈利→亏损，呈现出时而盈利时而亏损的曲线，且盈亏幅度相差不大
   - **半圆型/U型/V型波动**：先盈利后亏损，或先亏损后盈利，呈现出类似半圆的弧形或是较完整的U型、V型，终点有向零轴回归的趋势
3. **无方向性**：曲线盈利较小或趋近零，整体无明显方向性，曲线来回上下扭动

**关键特征**（giveup的核心标志）：
- **不是横盘**，而是盈利和亏损状态的反复切换
- 收益曲线有时因盈利而上升，有时因亏损而下降，且盈亏幅度大致相当
- 难以从收益曲线看出未来能持续盈利或亏损的走势

**不应判定为giveup的情况**：
- ❌ 在盈利区长期横盘（应判定为good）
- ❌ 在亏损区长期横盘（应判定为reverse）
- ❌ 有小幅回调但整体向上（应判定为good）
- ❌ 有小幅反弹但整体向下（应判定为reverse）
